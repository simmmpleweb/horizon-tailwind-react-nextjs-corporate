  ...
  return (
    <div className="relative mt-14 flex w-[256px] justify-center rounded-md bg-gradient-to-br from-[#868CFF] via-[#432CF3] to-brand-500 pb-4">
      ...
      <div className="mt-16 flex h-fit flex-col items-center">
        ...
        <a
          target="blank"
          className="text-medium mt-7 block rounded-2xl bg-gradient-to-b from-white/50 to-white/10 px-11 py-[12px] text-center text-base text-white hover:bg-gradient-to-b hover:from-white/40 hover:to-white/5 "
